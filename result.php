...
if(isset($_POST['username'],$_POST['password'])){
	...
	if($uname == 'admin' && $pwd == 'admin'){
		...
		echo '<script language="javascript">'; 
	        echo 'alert("Log in failed. Invalid credentials!")';
                echo '</script>';
		exit();
	}
}
                    ...
                    <div class="float">
                      <form class="form" action="home.php" method="post">
                            <div class="form-group">
                                <label class="label" for="username" class="text-white"><b>Write Something</label><br>
                                <input class="textArea" type="text" name="updatepost" class="form-control">
                            </div>
                            <div id="div1">
					              <input type="hidden" name="token" value="" id="tokenIn_hidden_field"/>
					        </div>
                            <div class="form-group">
                                <input id="submit2" type="submit"  class="btn btn-info btn-md" value="Update">
                            </div>
                      </form>
                    </div>
                </div>
